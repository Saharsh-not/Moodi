...
**Moodi** is a secure, Aadhaar-linked Android e-voting application that allows verified Indian citizens to register, authenticate, and cast their vote — all from their mobile phone. Built with Java and powered by Google Firebase.
...
│   │   │   ├── SignupActivity.java         # Voter registration
│   │   │   ├── LoginActivity.java         # Candidate list & voting
│   │   │   ├── ResultActivity.java         # Live vote results
│   │   │   └── ProfileActivity.java        # Voter profile & status
│   │   └── res/
